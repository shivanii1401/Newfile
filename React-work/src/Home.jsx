...
import bannerimg from "../src/assets/images/Home.svg";
import tata from "../src/assets/images/TATA-Capital.svg";
import times from "../src/assets/images/Timeslogo.svg";
import icici from "../src/assets/images/ICICI.svg";
import southindia from "../src/assets/images/SouthIndiaBank.svg";
import bob from "../src/assets/images/BOB.svg";
...
class Home extends React.Component{
    render(){
        return(
            ...
            <nav className="navbar sticky-top navbar-expand-lg bg-body-tertiary navigation">
               ...
               <div className="container">
                    <div className="row">
                        <div className="col-md-6">
                             <h1 className="heading1">E-Sign Online:<br/> 
                                The Fast, Secure, and<br/>
                                Eco-Friendly Way to Sign</h1>
                              <p className="para1">With eSign Document Infrastructure you get eSign, eStamp, Document <br/> Assembly, Document Enforceability, Automation, Security and <br/> MORE...all under one roof</p>
    ...
    <div className="container">
      <div className="row">
        <h1 className="heading2 text-center mt-5"><span className="text-primary">2000+ Indian Businesses</span>- from high-growth unicorns to the largest banks - use eSign to go paperless</h1>
      ...
      <section className="section4">
        <div className="container">
            <div className="row">
                <h1 className="text-center">For centuries, we''ve seen physical paperwork as an<br /> inevitable, unchangeable part of doing business.<span> With eSign,<br /> this changes forever </span></h1>
            </div>
            <div className="row">
                <div className="col-md-6">
                    <div className="box-left">
                        <div className="row">
                            ...
                            <div className="row " >
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                <path d="M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z" stroke="#2828C2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M14 8L8 14" stroke="#2828C2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M8 8L14 14" stroke="#2828C2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg> </div>
                                <div className=" col-10">
                                    <p className="leftp"> Critical business processes take days, if not weeks due to slow paperwork</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Teams spend hours daily bogged down in paperwork tasks</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Customers and business partners dread doing paperwork with you</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Physical documents are prone to mistakes, wear-and-tear and damage - putting your business at serious compliance risk </p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">You incur significant costs transporting, storing, tracking and managing paperwork </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="box-right">
                        <div className="row">
                            ...
                            <div className="row">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Critical business processes (loans, account openings, onboardings etc.)<strong> take minutes</strong> </p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Teams spend <strong>zero</strong> time on paperwork tasks</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Paperwork signing for your customers and business partners is <strong> faster and easier</strong> than making a digital payment</p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp">Documents executed through eSign are immune to damage and loss and come with presumptions of validity under the<strong>Evidence Act</strong> </p>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                ...
                                <div className="col-10">
                                    <p className="leftp"><strong>Zero</strong> logistics costs from paperwork</p>
                                </div>
                            </div>
      ...
      <section className="section5">
           <div className="container">
                <div className="row">
                  ...
                  <p className="">Everything your company needs to digitally transform its paperwork processes - in one unified solution</p>
                </div>
                <div className="row">
                  <div className="sec5card">
                    <div className="row">
                      <h3>Document Execution Flow</h3>
                      <p>Everything it takes to get a single document digitally executed</p>
                      <div className="row d-flex align-items-center justify-content-center">
                        <div className="col-md-3 sec5subcard">
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="27" height="36" viewBox="0 0 27 36" fill="none">
                                <path d="M16.7502 1.91309H4.41683C3.59908 1.91309 2.81482 2.25206 2.23658 2.85544C1.65835 3.45882 1.3335 4.27717 1.3335 5.13048V30.8696C1.3335 31.7229 1.65835 32.5413 2.23658 33.1446C2.81482 33.748 3.59908 34.087 4.41683 34.087H22.9168C23.7346 34.087 24.5188 33.748 25.0971 33.1446C25.6753 32.5413 26.0002 31.7229 26.0002 30.8696V11.5653L16.7502 1.91309Z" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M16.7495 1.91309V11.5653H25.9995" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M19.8328 19.6088H7.49951" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M19.8328 26.0435H7.49951" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M10.5828 13.174H9.04118H7.49951" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                   </svg></span>
                              </div>
                        ...
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="31" height="34" viewBox="0 0 31 34" fill="none">
                                <path d="M15.4 10.6C23.3529 10.6 29.8 8.45097 29.8 5.8C29.8 3.14903 23.3529 1 15.4 1C7.4471 1 1 3.14903 1 5.8C1 8.45097 7.4471 10.6 15.4 10.6Z" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path opacity="0.5" d="M29.8 17C29.8 19.656 23.4 21.8 15.4 21.8C7.4 21.8 1 19.656 1 17" stroke="#00E9FB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M1 5.79999V28.2C1 30.856 7.4 33 15.4 33C23.4 33 29.8 30.856 29.8 28.2V5.79999" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                               </svg></span>
                              </div>
                        ...
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="36" height="38" viewBox="0 0 36 38" fill="none">
                  ...
                  <div className="sec5card">
                  <div className="row">
                      <h3>Leegality X Factor</h3>
                      <p>What it takes to implement digital paperwork at scale. 84% of digital transformations fail. <br/>
                          The X Factor ensure we are in the 16%</p>
                      <div className="row d-flex align-items-center justify-content-center mb-5 pb-4">
                        <div className="col-md-3 sec5subcard ">
                          <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="42" height="39" viewBox="0 0 42 39" fill="none">
                            ...
                            <div className="col-8">
                              <h6>Execution Automation <br /> & Logistics</h6>
  ...
  <path d="M25.7274 5.36365H8.27286C6.66621 5.36365 5.36377 6.66609 5.36377 8.27274V25.7273C5.36377 27.3339 6.66621 28.6364 8.27286 28.6364H25.7274C27.3341 28.6364 28.6365 27.3339 28.6365 25.7273V8.27274C28.6365 6.66609 27.3341 5.36365 25.7274 5.36365Z" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M21.3635 12.6364H12.6362V21.3636H21.3635V12.6364Z" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M12.6362 1V5.36364" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M21.3638 1V5.36364" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M12.6362 28.6364V33" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M21.3638 28.6364V33" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M28.6362 12.6364H32.9999" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M28.6362 19.9091H32.9999" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M1 12.6364H5.36364" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M1 19.9091H5.36364" stroke="#01E4F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></span>
                              </div>
                        ...
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="36" height="37" viewBox="0 0 36 37" fill="none">
                            ...
                            <div className="col-8">
                              <h6>Customer <br/> Success Service</h6>
                  ...
                  <div className="row">
                      ...
                      <p>Powerful Enterprise Administrative capabilities right out of the box</p>
                      <div className="row d-flex align-items-center justify-content-center">
                        <div className="col-md-3 sec5subcard">
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="46" height="43" viewBox="0 0 46 43" fill="none">
                            ...
                            <div className="col-8">
                              <h6>User Management <br /> & Control Access </h6>
                        ...
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="33" height="37" viewBox="0 0 33 37" fill="none">
                            ...
                            <div className="col-8">
                              <h6>Document & Info <br /> Security</h6>
                        ...
                        <div className="row">
                            <div className="col-3">
                              <div className="sqr">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39" fill="none">
                  ...
                  <h2 className="heading2sec5">Do you want to remove the paper from paperwork?</h2>
                  <div>
